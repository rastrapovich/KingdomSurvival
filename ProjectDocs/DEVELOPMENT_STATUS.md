...
**Проверка:**  (4) — фраза «когда выпадает» для разовой, повторяемой и прямой встречи; строка списка без технических кодов; окно строится на настоящей базе на всех трёх вкладках. EditMode **1145 — 1131 passed / 0 failed / 14 skipped**. Вид окна вручную не проверялся.
