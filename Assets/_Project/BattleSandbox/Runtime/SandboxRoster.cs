...
namespace KingdomSurvival.BattleSandbox
{
    public static class SandboxRoster
    {
        ...
        {
            new SandboxUnitDefinition("garrick", "Гаррик", "Гвардеец", SandboxUnitRole.Guard, 100, 3, 6, 3, 5, 1),
            new SandboxUnitDefinition("edric", "Эдрик", "Лучник", SandboxUnitRole.Archer, 90, 4, 2, 3, 6, 4),
            new SandboxUnitDefinition("marta", "Марта", "Лекарь", SandboxUnitRole.Healer, 85, 1, 2, 3, 4, 1),
            new SandboxUnitDefinition("torvin", "Торвин", "Копейщик", SandboxUnitRole.Spearman, 100, 3, 4, 3, 5, 1),
            new SandboxUnitDefinition("agnessa", "Агнесса", "Разведчик", SandboxUnitRole.Scout, 90, 2, 3, 4, 8, 1),
            new SandboxUnitDefinition("osvald", "Освальд", "Ополченец", SandboxUnitRole.Militia, 100, 2, 3, 3, 4, 1)
        };

        private static readonly SandboxUnitDefinition[] EnemyRosterData =
        {
            new SandboxUnitDefinition("forest_wolf_1", "Лесной волк", "Зверь", SandboxUnitRole.Beast, 60, 5, 2, 4, 7, 1),
            new SandboxUnitDefinition("forest_wolf_2", "Лесной волк", "Зверь", SandboxUnitRole.Beast, 60, 5, 2, 4, 7, 1),
            new SandboxUnitDefinition("dire_wolf", "Матёрый волк", "Зверь", SandboxUnitRole.Beast, 90, 6, 4, 4, 6, 1),
            new SandboxUnitDefinition("forest_beast", "Лесная тварь", "Зверь", SandboxUnitRole.Beast, 100, 7, 5, 3, 3, 1)
        };
