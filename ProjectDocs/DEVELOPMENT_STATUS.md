...
Остаётся по ПР-02: решить, обязательны ли все три расследования N07; вариант «узлы через Дом, людей и место»; скриптовый прогон второй половины главы (N11 → Совет, три исхода); замер темпа начала.
