...
Не проверено вручную в игре: блок «Дела в Доме» на экране, ожидание ночи, открытие сцен по карточкам.

Остаётся по ПР-02: ручная проверка домашней части в Play Mode; вычитка черновиков текста N08/N09; замер темпа начала.
