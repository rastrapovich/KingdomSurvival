...
>
> Актуальный общий канон: `KINGDOM_SURVIVAL_GAME_CONCEPT_CANON_RU_v1_45.md`.
>
> Единая энциклопедия мира: `ProjectDocs/LORE.md`.
>
> Единая нарративная библия: `ProjectDocs/NARRATIVE.md`.
>
> План и карта разработки: `ProjectDocs/PROTOTYPE_DEVELOPMENT_PLAN.md` (этапы `ПР-00…ПР-13`). Порядок работ задаёт план; этот журнал фиксирует выполнение его этапов.
>
...
**С 25.09.2026 (канон v1.45 §6.0) основной этап — ПР-12 «Свободная игра»:** базовый режим без сюжетной линии и тайны кризиса, на тех же системах; сначала он доводится до интересного состояния, затем — кризисы поверх него. «Дом на чужой воде» сохранён, его разработка приостановлена, прогон главы остаётся зелёным. Текст ниже о первой главе — история, а не текущий приоритет.
...
С 24.09.2026 дальнейшая реализация идёт по карте разработки `ProjectDocs/PROTOTYPE_DEVELOPMENT_PLAN.md`. Первый этап — **ПР-00**: зафиксировать стартовую рабочую сборку, прогнать тесты, провести ревизию структурных тестов и вручную пройти N01–N17. Коды `P09…P13` в этом журнале относятся к этапам первой главы, а не к этапам плана.
