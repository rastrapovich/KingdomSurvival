    ...
    private static readonly List<DecisionDefinition> Definitions =
        new List<DecisionDefinition>
        {
            ...
            new DecisionDefinition(
                "abandoned_wagon",
                "Брошенный обоз",
                "У дороги стоит перевёрнутая телега. Следов хозяев нет, зато под промокшим брезентом видны целые ящики. Осторожный обыск займёт время, но может пополнить походный запас.",
                new DecisionOptionDefinition(
                    "search",
                    "Обыскать обоз",
                    5,
