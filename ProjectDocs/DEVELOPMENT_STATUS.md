...
>
> Актуальный общий канон: `KINGDOM_SURVIVAL_GAME_CONCEPT_CANON_RU_v1_48.md`.
>
...
**Основной этап — ПР-12 «Свободная игра»** (канон v1.45 §6.0; последствия — v1.46 §25; освоение, обучение и социальная реакция — v1.47 §26; единая прогрессия и боевой XP — v1.48 §27). Базовый цикл Дома, похода и возвращения работает, но содержательные поводы для следующего выхода и заметные отложенные последствия ещё требуют авторской работы. «Дом на чужой воде» сохранён как первая кампания кризиса; его разработка приостановлена. Подробности ниже о N01–N17 и P09–P13 — история разработки главы, а не текущий приоритет.
